...
export default function PageHero({
  ...
  subtitle,
  description,
  backgroundImage = "https://images.unsplash.com/photo-1666875753105-c63a6f3bdc86?q=80&w=2070&auto=format&fit=crop",
}: PageHeroProps) {
  return (
    <section
      className="section genixo-hero-section-03 product-detail-hero d-flex align-items-center justify-content-center"
      style={{
        ...
        <div className="row align-items-center h-100">
          <div className="col-12 col-sm-11 col-md-10 col-lg-10 col-xl-8 mx-auto mx-md-0">
            <div className="hero-content hero-content-animate">
              {subtitle && (
                <h3 className="sub-title hero-subtitle-animate">{subtitle}</h3>
              )}
              <h1 className="title hero-title-animate">{title}</h1>
              {description && (
