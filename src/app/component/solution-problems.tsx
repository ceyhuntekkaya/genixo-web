...
export default function SolutionProblems({ service }: SolutionProblemsProps) {
  // Check if service has problems data
  if (
    !service.problems ||
      ...
      <div className="container">
        <div className="choose-us-wrap">
          <div className="section-title text-center">
            <h3 className="sub-title-modern">{service.problemsSubtitle}</h3>
            <h2 className="title">{service.problemsTitle}</h2>
          </div>
