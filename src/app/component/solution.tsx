                            ...
                            <div className="swiper-slide">
                                <div className="single-case-study-02">
                                    ...
                                    <div className="case-study-content">
                                        ...
                                        <h3 className="title"><a href="#"><span>Structure</span> <br/> <span>of
                        Malnufication</span></a></h3>
                                        <p className="text">Accelerate innovation with world-className tech teams We’ll
                                            match
                                            you to
                                            an entire remote team of incredible freelance talent for all your </p>
                                    </div>
                                </div>
                            </div>
                            <div className="swiper-slide">
                                <div className="single-case-study-02">
                                    ...
                                    <div className="case-study-content">
                                        <p className="sub-title">Database Security</p>
                                        <h3 className="title"><a href="#"><span>Multifunctional</span> <br/> <span>of
                        Technology</span></a></h3>
                            ...
                            <div className="swiper-slide">
                                <div className="single-case-study-02">
                                    ...
                                    <div className="case-study-content">
                                        <p className="sub-title">Database Security</p>
                                        <h3 className="title"><a href="#"><span>Blockchain</span> <br/> <span>of
                        technology</span></a></h3>
                                        <p className="text">Accelerate innovation with world-className tech teams We’ll
                                            match
                                            you to
