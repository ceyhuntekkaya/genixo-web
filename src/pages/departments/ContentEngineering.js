...
export default function ContentEngineering() {
    return (
                                                    ...
                                                    <div className="col-lg-4 col-md-6 col-sm-6">
                                                        ...
                                                        <div className="featured-icon-box icon-align-top-content style1">
                                                            ...
                                                            <div className="featured-hover-content">
                                                                ...
                                                                <Link className="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" to="i/consultancy">More Details<i className="icon-right"></i></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
