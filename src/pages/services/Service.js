...
export default function Service() {
  return (
    <div className="site-main">
            ...
            <section className="cmt-row bg-base-dark cmt-bg cmt-bgimage-yes bg-img5 clearfix">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="section-title title-style-center_text">
                                <div className="title-header">
                                    <h3>Quick Facts</h3>
                                    <h2 className="title text-base-white">We believe in counting numbers</h2>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="cmt-horizontal_sep width-100 mt-65 mb-70 res-991-mt-30 res-991-mb-35"></div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="section-title style2 res-991-mb_20">
                                ...
                                <div className="title-desc">
                                    <p>Every IT team is different, based on the culture & needs of its company, the experience & skills of the team members. Types of systems on which they are working. Here's the Devfox's work force</p>
                                </div>
                            </div><!-- section title end -->
            ...
            <section className="cmt-row padding_zero-section clearfix">
                <div className="container">
                    <div className="row mt_160 res-991-mt-40">
                        <div className="col-lg-4 col-md-4 col-sm-12">
                            <!--featured-imagebox-services-->
                            <div className="featured-imagebox featured-imagebox-services style1">
                                <!-- featured-thumbnail -->
                                <div className="featured-thumbnail">
                                    <a href="it-consultancy.html"><img width="740" height="500" className="img-fluid auto_size" src="images/services/services-01.jpg" alt="image"/></a>
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-services style1">
                                <!-- featured-thumbnail -->
                                <div className="featured-thumbnail">
                                    <a href="experience-design.html"><img width="740" height="500" className="img-fluid auto_size" src="images/services/services-02.jpg" alt="image"/></a>
                                </div><!-- featured-thumbnail end-->
                                <div className="featured-content">
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-services style1">
                                <!-- featured-thumbnail -->
                                <div className="featured-thumbnail">
                                    <a href="digital-services.html"><img width="740" height="500" className="img-fluid auto_size" src="images/services/services-03.jpg" alt="image"/></a>
                                </div><!-- featured-thumbnail end-->
                                <div className="featured-content">
            ...
            <!--step-section-->
            <section className="cmt-row step-section clearfix">
                <div className="container">
                    <!-- row -->
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="section-title title-style-center_text">
                                <div className="title-header">
                                    <h3>how it works</h3>
                                    <h2 className="title">Start your new skill in easy steps</h2>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    </div>
                            ...
                            <div className="featured-icon-box icon-align-top-content style2">
                                <div className="featured-icon">
                                    <div className="cmt-icon cmt-icon_element-fill cmt-icon_element-style-rounded cmt-icon_element-color-white cmt-icon_element-size-lg">
                                        <div className="cmt-num"><span className="number"></span></div>
                                    </div>
                                </div>
                                <div className="featured-content">
                                    <div className="featured-icon">
            ...
            <section className="cmt-row padding_top_zero-section clearfix">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-12">
                            <!-- col-img-img-two -->
                            <div className="cmt-bg cmt-col-bgimage-yes col-bg-img-two pt-60 res-991-pt-0">
                                ...
                                <div className="layer-content">
                                    ...
                                    <div className="row g-0">
                                        <div className="col-lg-8">
                                            ...
                                            <a className="cmt-btn btn-default cmt-icon-btn-left cmt-btn-size-md cmt-btn-color-dark mt-50 res-991-mt-30" href="contact-us.html"><i className="icon-right"></i><span>see more plans</span></a>
                                        </div>
                                        <div className="col-lg-4">
